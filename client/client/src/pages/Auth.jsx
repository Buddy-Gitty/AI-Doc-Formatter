...
import { Wand2, Mail, Lock, Sun, Moon } from 'lucide-react';
import '../App.css';
    ...
    <div className="auth-container d-flex align-items-center justify-content-center min-vh-100">
      <div className="auth-card glass-panel p-5 animate-fade-in" style={{ width: '100%', maxWidth: '450px' }}>
        ...
        <div className="text-center mb-5">
          ...
          <h2 className="theme-text-primary fw-bold">{isLogin ? 'Welcome Back' : 'Create an Account'}</h2>
        ...
        <form onSubmit={handleAuth}>
          <div className="mb-4">
            <label className="form-label theme-text-primary">Email address</label>
            <div className="input-group">
              <span className="input-group-text border-secondary theme-text-secondary">
                <Mail size={18} />
              </span>
              <input
                type="email"
                className="form-control border-secondary theme-text-primary custom-input"
          ...
          <div className="mb-5">
            <label className="form-label theme-text-primary">Password</label>
            <div className="input-group">
              <span className="input-group-text border-secondary theme-text-secondary">
                <Lock size={18} />
              </span>
