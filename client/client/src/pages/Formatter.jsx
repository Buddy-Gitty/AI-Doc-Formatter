...
- CRITICAL: If the document has a main title, put it ONLY in the "title" field of the JSON. DO NOT repeat the title as a section in the "sections" array. This is extremely important to avoid duplicate titles.
...
function Formatter({ session, theme, toggleTheme }) {
    ...
    return (
      <div className="doc-preview animate-fade-in mt-4">
        ...
        {layout.sections.map((section, index) => {
          // Safety check: skip duplicate title in preview
          if (index === 0 && layout.title && section.content &&
            section.content.toLowerCase().trim() === layout.title.toLowerCase().trim()) {
            return null;
          }
  ...
  return (
    <div className="app-container">
      <div className="d-flex justify-content-between p-3">
        <div className="d-flex justify-content-start p-3 align-items-center gap-2">
          <button className="btn btn-outline-theme m-2" onClick={() => navigate('/')}>Home</button>
          <button 
              onClick={toggleTheme} 
              className="btn btn-link theme-text-secondary p-2 theme-toggle-btn"
        ...
        <div className="d-flex justify-content-end p-3">
          <button className="btn btn-outline-theme m-2" onClick={handleLogout}>
            Logout
          </button>
        </div>
      </div>
        ...
        <div className="row justify-content-center mt-5">
          <div className="col-lg-10">
            <div className="d-flex justify-content-between align-items-center mb-3 animate-fade-in">
              ...
              <button className={`btn ${session ? 'btn-success' : 'btn-primary'} btn-lg`} onClick={handleDownload}>
                {session ? '⬇️ Download .docx' : '🔐 Login to Download'}
              </button>
            </div>
